...
$nonFeatured = $review->getNonFeatured();
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <h3 class="mb-0">
                <a class="text-dark" href="#"><?php echo $one['email']; ?></a>
              </h3>
              <div class="mb-1 text-muted"><?php echo $one['date']; ?></div>
              <p class="card-text mb-auto">
                  <?php echo substr($one['review'], 0, 130); ?>
              </p>
            </div>
